#!/usr/bin/env python3
"""Exploratory N=24 gamma probe for the Bombelli annealer.

Provenance:
- Requested as an exploratory SORKIN-2 gamma-resonance probe.
- Adapted from explore/gamma_n36_probe after N=36 proved too expensive
  for this exploratory scan.
- Reuses the existing known-truth sprinkling and recovery machinery in
  validation_suite.py.
- Writes only to explore/gamma_n24_probe/ and does not modify benchmark
...
CSV_PATH = OUT_DIR / "gamma_n24_probe.csv"
MD_PATH = OUT_DIR / "gamma_n24_probe.md"
SVG_PATH = OUT_DIR / "gamma_n24_probe.svg"
...
def write_svg(rows: list[dict[str, object]]) -> None:
  ...
  <text x='{width/2:.0f}' y='34' text-anchor='middle' font-family='serif' font-size='22' fill='#222'>N=24 gamma probe</text>
